  ...
  return (
    <div className="grid grid-cols-1 gap-14">
      <div>
        <div className="flex">
          <p
            className={menuActive === "short" ? "menu-active" : "menu"}
            onClick={() => setMenuActive("short")}
          >
            Short Url
          </p>
          <p
            className={menuActive === "qrcode" ? "menu-active" : "menu"}
            onClick={() => setMenuActive("qrcode")}
          >
            QR Generator
          </p>
        </div>
